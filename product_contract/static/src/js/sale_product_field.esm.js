...
patch(SaleOrderLineProductField.prototype, {
    ...
    get contractContext() {
        ...
        return {
            ...
            default_partner_id: this.props.record.model.root.data.partner_id.id,
            default_company_id: this.props.record.model.root.data.company_id.id,
            ...
            default_contract_id: this.props.record.data.contract_id.id,
